          ...
          <div class="row justify-content-center">
            ...
            <form class="form-inline">
                <div class="col-lg-12">
                      ...
                      <div class="linkedin">
                      <a href="http://www.linkedin.com/shareArticle?mini=true&url=<?php echo $url; ?> &title=<?php echo $title;?>&summary=<?php echo $summary;?>&source=" class="popup"rel="nofollow"><button class="primary btn btn-md btn-secondary"><i class="fa fa-linkedin icon-footer"></i> Linkedin</button></a>
                      </div>
